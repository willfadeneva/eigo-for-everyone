  ...
  if (state === "loading" || state === "joining") return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center text-white">
      <div className="text-center space-y-4">
        <div className="w-12 h-12 border-4 border-[#C76FD8] border-t-transparent rounded-full animate-spin mx-auto"/>
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center text-white px-4">
      <div className="text-center max-w-md space-y-4">
        ...
        <div className="flex gap-3 justify-center">
          <Button onClick={init} className="bg-[#C76FD8] text-white">Retry</Button>
    ...
    <div className="min-h-screen bg-slate-900 flex flex-col">
          ...
          {participants.length < 2 && (
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="text-center text-white">
                <div className="w-20 h-20 rounded-full bg-[#6AABDD] flex items-center justify-center text-4xl font-bold mx-auto mb-3">S</div>
        ...
        {chatOpen && (
          <div className="w-72 bg-slate-800 flex flex-col border-l border-slate-700">
            ...
            <form onSubmit={sendMessage} className="p-3 border-t border-slate-700 flex gap-2">
              ...
              />
              <button type="submit" className="text-[#C76FD8] hover:text-indigo-400"><Send size={16}/></button>
            </form>
          </div>
        )}
      </div>
      ...
      <div className="bg-slate-800 py-4 flex items-center justify-center gap-4">
        ...
        <button onClick={() => setChatOpen(!chatOpen)}
          className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors ${chatOpen ? "bg-[#6AABDD]" : "bg-slate-600 hover:bg-[#fafafa]0"}`}>
