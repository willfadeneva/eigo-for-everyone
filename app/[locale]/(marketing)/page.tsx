    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#f0eeff] via-[#ffffff] to-[#fff0f9] py-20 sm:py-28 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white border border-[#fbcfe8] rounded-full px-4 py-1.5 text-sm text-[#D946EF] font-medium mb-6 shadow-sm">
            <Shield size={14} className="text-[#D946EF]" /> {t("heroTag")}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/tutors">
              <Button size="lg" className="bg-[#38BDF8] hover:bg-[#D946EF] text-white px-8 py-4 text-base rounded-full w-full sm:w-auto">
                {t("findTutor")} <ChevronRight size={16} className="ml-1" />
              </Button>
            </Link>
            <Link href="/how-it-works">
              <Button size="lg" variant="outline" className="border-[#D946EF] text-[#D946EF] px-8 py-4 text-base rounded-full w-full sm:w-auto">
                {t("howItWorks")}
              </Button>
            </Link>
          </div>
      ...
      {/* ── Stats ── */}
      <section className="bg-[#38BDF8] py-10 px-4">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 sm:py-20">
        <div className="flex items-end justify-between mb-8">
          ...
          <Link href="/tutors" className="text-[#D946EF] font-medium text-sm hidden sm:block hover:underline">
            {t("viewAll")}
          </Link>
        </div>
            ...
            <Card key={t2.id} className="hover:shadow-lg transition-shadow border border-[#fdf2f8]">
              <CardContent className="p-5">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-bold text-[#D946EF]">{t2.rate}<span className="text-xs font-normal text-slate-400"> /50min</span></span>
                  <Link href={`/tutors/${t2.id}`}>
                    <Button size="sm" className="bg-[#D946EF] text-white text-xs">{t("findTutor")}</Button>
                  </Link>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="text-center mt-6 sm:hidden">
          <Link href="/tutors" className="text-[#D946EF] font-medium">{t("viewAll")}</Link>
        </div>
      </section>
            ...
            return (
              <div key={step.step} className="text-center">
                <div className="w-16 h-16 rounded-2xl bg-[#fce7f3] flex items-center justify-center mx-auto mb-4">
                  <Icon size={28} className="text-[#D946EF]" />
                </div>
                <div className="text-xs font-bold text-[#D946EF] uppercase tracking-widest mb-1">Step {step.step}</div>
      ...
      {/* ── CTA ── */}
      <section className="py-20 px-4 text-center bg-gradient-to-r from-[#D946EF] to-[#D946EF]">
        ...
        <Link href="/tutors">
          <Button size="lg" className="bg-white text-[#D946EF] hover:bg-[#fafafa] px-10 py-4 text-base rounded-full font-semibold">
            {t("ctaButton")}
          </Button>
        </Link>
      </section>
