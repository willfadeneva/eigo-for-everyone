    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0 space-y-8">
          ...
          {/* About */}
          <div>
            <h2 className="text-lg font-semibold text-[#0f172a] mb-3">About me</h2>
          ...
          {/* Certifications */}
          <div>
            <h2 className="text-lg font-semibold text-[#0f172a] mb-3">Certifications</h2>
          ...
          {/* Availability */}
          <div>
            <h2 className="text-lg font-semibold text-[#0f172a] mb-4">Weekly availability <span className="text-sm font-normal text-slate-400">(IST)</span></h2>
