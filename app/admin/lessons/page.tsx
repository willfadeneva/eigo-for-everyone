          ...
          <TableBody>
            {lessons.map(l => (
              <TableRow key={l.id} className="text-sm">
                ...
                <TableCell className="text-slate-600">{l.tutor}</TableCell>
                <TableCell>
                  <Badge className={`text-xs ${TYPE_COLORS[l.type] ?? ""}`}>{l.type}</Badge>
                </TableCell>
                <TableCell className="text-slate-500 text-xs whitespace-nowrap">{l.date}</TableCell>
                <TableCell className="text-slate-500">{l.duration} min</TableCell>
                <TableCell className="font-medium text-[#3730a3]">
