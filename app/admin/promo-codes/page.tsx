      ...
      <Card className="border border-[#fdf2f8]">
        <CardContent className="p-5">
          ...
          <form onSubmit={addCode} className="grid sm:grid-cols-4 gap-3 items-end">
            ...
            <Button type="submit" className="bg-[#8774DB] text-white sm:col-span-4 sm:w-fit">Create code</Button>
          </form>
        </CardContent>
      </Card>
      ...
      <div className="rounded-xl border border-[#fdf2f8] overflow-hidden bg-white">
        <Table>
          ...
          <TableBody>
            {codes.map(c => (
              <TableRow key={c.code}>
                <TableCell className="font-mono font-semibold text-[#8774DB]">{c.code}</TableCell>
