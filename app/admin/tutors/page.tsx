...
export default function AdminTutorsPage() {
  ...
  return (
    <div className="p-6 max-w-6xl">
      <h1 className="text-2xl font-bold text-[#0f172a] mb-6">Tutor Management</h1>
          ...
          <TableBody>
            {filtered.map(t => (
              <TableRow key={t.id}>
                ...
                <TableCell className="text-sm text-[#475569]">{t.lessons.toLocaleString()}</TableCell>
                <TableCell className="text-sm text-[#64748b]">{t.joined}</TableCell>
                <TableCell>
