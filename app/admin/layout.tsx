      ...
      <div className="min-h-screen flex items-center justify-center bg-[#0f172a]">
        <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm">
          <div className="text-center mb-6">
            <div className="text-3xl font-bold text-[#C76FD8]">英語 Eigo</div>
          ...
          <form onSubmit={login} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-[#fce7f3] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#C76FD8]"
            ...
            <button type="submit"
              className="w-full bg-[#6AABDD] hover:bg-[#C76FD8] text-white font-semibold py-2.5 rounded-lg text-sm transition-colors">
              Sign in
            </button>
          </form>
        </div>
            ...
            return (
              <Link key={href} href={href}
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  active ? "bg-[#C76FD8] text-white" : "text-pink-200 hover:bg-white/10 hover:text-white"
                }`}>
                <Icon size={16}/>
                {label}
