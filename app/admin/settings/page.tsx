...
function SaveButton({ onClick }: { onClick: () => void }) {
  ...
  return (
    <Button onClick={handle} className="bg-[#49D1FD] hover:bg-[#8774DB] text-white flex items-center gap-2">
            ...
            <button key={t} onClick={() => setActiveTab(t)}
              className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                t === "danger"
                  ...
                  : activeTab === t ? "bg-white text-[#8774DB] shadow-sm" : "text-[#64748b] hover:text-slate-700"
              }`}>
              {TAB_LABELS[t]}
            </button>
          ))}
            ...
            <CardContent className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={payoutCycle} onChange={e => setPayoutCycle(e.target.value)}
                    className="mt-1 w-full border border-[#fce7f3] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#8774DB]">
              ...
              <div>
                ...
                <select value={currency} onChange={e => setCurrency(e.target.value)}
                  className="mt-1 w-full border border-[#fce7f3] rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#8774DB] max-w-xs">
